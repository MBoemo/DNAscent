...
# FROM NANOPOLISH WRITTEN BY JARED SIMPSON (https://github.com/jts/nanopolish/blob/master/scripts/dropmodel.py)
# FIXED BY MAB FOR ALBACORE > 1.2
...
for pmer in pmers:
    ...
    kmers_with_pmer = [ a + pmer for a in alphabet ]
    samples = list()
