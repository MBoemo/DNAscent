OBJS = event_detection.o event_handling.o common.o data_IO.o Osiris_build.o Osiris_detect.o Osiris.o
CC = gcc
CXX = g++
DEBUG = -g
LIBFLAGS = -L Penthus/ -l Penthus -L htslib-1.8/ -l hts -L hdf5-1.8.14/hdf5/lib/ -l hdf5 -fopenmp
...
$(HDF5_LIB):
	...
	pwd
	HDF5_SHARED_LIB=$HDF5_SHARED_LIB:./hdf5-1.8.14/hdf5/lib && export HDF5_SHARED_LIB
...
Osiris_build.o : src/poreSpecificParameters.h src/common.h src/build_model.h src/data_IO.h src/error_handling.h src/event_handling.h src/poreModels.h src/Osiris_build.h src/Osiris_build.cpp $(HTS_LIB) $(HDF5_LIB) $(PENTHUS_LIB)
	$(CXX) $(CXXFLAGS) $(HTS_INCLUDE) $(HDF5_INCLUDE) $(FAST5_INCLUDE) src/Osiris_build.cpp $(LIBFLAGS)

#Osiris_detect.o : src/poreSpecificParameters.h src/common.h src/build_model.h src/data_IO.h src/error_handling.h src/event_handling.h src/Osiris_detect.h src/Osiris_detect.cpp
#	$(CXX) $(CXXFLAGS) src/Osiris_detect.cpp $(LIBFLAGS)

Osiris.o : src/Osiris.cpp src/Osiris_build.h src/Osiris_detect.h src/data_IO.h src/build_model.h src/event_handling.h
