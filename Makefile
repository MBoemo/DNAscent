OBJS = event_detection.o event_handling.o common.o data_IO.o Osiris_train.o Osiris_detect.o Osiris.o
CC = gcc
CXX = g++
DEBUG = -g
...
Osiris_train.o : src/poreSpecificParameters.h src/common.h src/build_model.h src/data_IO.h src/error_handling.h src/event_handling.h src/poreModels.h src/Osiris_train.h src/Osiris_train.cpp
...
Osiris.o : src/Osiris.cpp src/Osiris_train.h src/Osiris_detect.h src/data_IO.h src/build_model.h src/event_handling.h
